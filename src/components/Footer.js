      ...
      return(
  	     <div className='contact-container2'>
		         <div className="column-footer" id="column-footer">      
                  ...
                  <p><a href="https://twitter.com/JacksCreekcom"><input type="image" src={require('../images/twitter32.png')} id="twitter" title="Twitter" alt="Twitter" /></a>
                    <a href="https://github.com"><input type="image" src={require('../images/github32.png')} id="github" title="Github" alt="Github" /></a>  
                    <a href="https://reactjs.org"><input type="image" src={require('../images/reactnative32.png')} id="react" title="Reactjs.org" alt="React" /></a>
                  </p>                                 
              </div>   
		        </div>
        </div>	   
